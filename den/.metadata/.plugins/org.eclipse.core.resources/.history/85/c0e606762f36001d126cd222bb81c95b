...
public interface UiPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http:///den/ui.ecore";
	 ...
	 * @generated
	 */
	UiPackage eINSTANCE = den.ui.impl.UiPackageImpl.init();

	/**
	 * The meta object id for the '{@link den.ui.impl.UIImpl <em>UI</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see den.ui.impl.UIImpl
	 * @see den.ui.impl.UiPackageImpl#getUI()
	 * @generated
	 */
	int UI = 0;
	...
	/**
	 * Returns the meta object for class '{@link den.ui.UI <em>UI</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the container reference '{@link den.ui.UI#getTheModelFactory <em>The Model Factory</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference '{@link den.ui.UI#getTheDomain <em>The Domain</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link den.ui.impl.UIImpl <em>UI</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see den.ui.impl.UIImpl
		 * @see den.ui.impl.UiPackageImpl#getUI()
