 ...
 * @generated
 */
public class RutaSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RutaPackage.FACTORY_RUTA: {
				FactoryRuta factoryRuta = (FactoryRuta)theEObject;
				T result = caseFactoryRuta(factoryRuta);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RutaPackage.RUTA: {
				Ruta ruta = (Ruta)theEObject;
				T result = caseRuta(ruta);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RutaPackage.TARIFA: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Factory Ruta</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Factory Ruta</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFactoryRuta(FactoryRuta object) {
		return null;
	}
