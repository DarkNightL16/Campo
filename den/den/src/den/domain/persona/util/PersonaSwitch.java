 ...
 * @generated
 */
public class PersonaSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PersonaPackage.CLIENTE: {
				Cliente cliente = (Cliente)theEObject;
				T result = caseCliente(cliente);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PersonaPackage.CONDUCTOR: {
				Conductor conductor = (Conductor)theEObject;
				T result = caseConductor(conductor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PersonaPackage.EMPLEADO: {
				Empleado empleado = (Empleado)theEObject;
				T result = caseEmpleado(empleado);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PersonaPackage.FACTORY_PERSONA: {
				FactoryPersona factoryPersona = (FactoryPersona)theEObject;
				T result = caseFactoryPersona(factoryPersona);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PersonaPackage.PERSONA: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Factory Persona</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Factory Persona</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFactoryPersona(FactoryPersona object) {
		return null;
	}
