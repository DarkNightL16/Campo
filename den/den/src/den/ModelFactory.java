 ...
 * </p>
 * <ul>
 *   <li>{@link den.ModelFactory#getTheDomain <em>The Domain</em>}</li>
 *   <li>{@link den.ModelFactory#getTheUI <em>The UI</em>}</li>
 * </ul>
 *
 * @see den.denPackage#getModelFactory()
 * @model
 * @generated
 */
public interface ModelFactory extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link den.domain.Domain#getTheModelFactory <em>The Model Factory</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see den.denPackage#getModelFactory_TheDomain()
	...
	/**
	 * Sets the value of the '{@link den.ModelFactory#getTheDomain <em>The Domain</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link den.ui.UI#getTheModelFactory <em>The Model Factory</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setTheUI(UI)
	 * @see den.denPackage#getModelFactory_TheUI()
	 * @see den.ui.UI#getTheModelFactory
	 * @model opposite="theModelFactory" containment="true"
	 * @generated
	 */
	UI getTheUI();
	...
	/**
	 * Sets the value of the '{@link den.ModelFactory#getTheUI <em>The UI</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
