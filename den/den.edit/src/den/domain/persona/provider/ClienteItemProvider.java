...
/**
 * This is the item provider adapter for a {@link den.domain.persona.Cliente} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClienteItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cliente_idCliente_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cliente_idCliente_feature", "_UI_Cliente_type"),
				 PersonaPackage.Literals.CLIENTE__ID_CLIENTE,
				 true,
				 false,
				 false,
	...
	protected void addEstadoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cliente_estado_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cliente_estado_feature", "_UI_Cliente_type"),
				 PersonaPackage.Literals.CLIENTE__ESTADO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Cliente)object).getIdCliente();
