...
/**
 * This is the item provider adapter for a {@link den.domain.envio.DetallePedido} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DetallePedidoItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DetallePedido_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DetallePedido_id_feature", "_UI_DetallePedido_type"),
				 EnvioPackage.Literals.DETALLE_PEDIDO__ID,
				 true,
				 false,
				 false,
	...
	protected void addCantidadPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DetallePedido_cantidad_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DetallePedido_cantidad_feature", "_UI_DetallePedido_type"),
				 EnvioPackage.Literals.DETALLE_PEDIDO__CANTIDAD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EnvioPackage.Literals.DETALLE_PEDIDO__DESCRIPCION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EnvioPackage.Literals.DETALLE_PEDIDO__VALOR_UNITARIO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((DetallePedido)object).getId();
